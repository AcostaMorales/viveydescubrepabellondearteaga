...
const TemploDelSagradoCorazon = () => {
  ...
  const galleryImages = [
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC1.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC2.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC3.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC4.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC5.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC6.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC7.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC8.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC9.jpeg", alt: alt1 },
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/RutaReligiosa/TDelSagradoCorazon/Carrusel/TDelSagradoCorazonC10.jpeg", alt: alt1 },
