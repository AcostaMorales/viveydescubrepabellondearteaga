...
const HaciendaDeLetras = () => {
  ...
  const galleryImages = [
    { src: rutaImagenesBase + "ImagenesRepertorio/Contenido/TierraDeVinos/HaciendaDeLetras/Carrusel/HaciendaDeLetrasC1.jpg", alt: alt1 },
    ...
    <div className="detail-page">
      ...
      <div className="detail-content">
        ...
        <LocationMap
          ...
          description="Vinícola histórica con recorridos, catas y experiencias enoturísticas"
          showDirections={true}
          mapHeight="350px"
        />
      </div>
