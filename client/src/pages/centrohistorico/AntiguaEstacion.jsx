...
const AntiguaEstacion = () => {
  ...
  const galleryImages = [
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC1.png", alt: "Fachada principal de la estación." },
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC2.png", alt: "Fachada principal de la estación." },
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC3.png", alt: "Fachada principal de la estación." },
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC4.png", alt: "Vías del ferrocarril y entorno inmediato" },
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC5.png", alt: "Vías del ferrocarril y entorno inmediato" },
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC6.png", alt: "Vías del ferrocarril y entorno inmediato" },
    { src: "/assents/imagenes/AntiguaEstacion/Carrusel/AntiguaEstacionC7.png", alt: "Detalles arquitectónicos interiores y exteriores." }
  ];
