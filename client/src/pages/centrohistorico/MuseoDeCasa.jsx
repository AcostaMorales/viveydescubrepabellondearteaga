...
const MuseoDeCasa = () => {
  ...
  const alt1 = "";
  const galleryImages = [
    { src: "/assents/imagenes/MuseoDeCasa/Carrusel/MuseoDeCasaC1.png", alt: alt1 },
    { src: "/assents/imagenes/MuseoDeCasa/Carrusel/MuseoDeCasaC2.png", alt: alt1 },
    { src: "/assents/imagenes/MuseoDeCasa/Carrusel/MuseoDeCasaC3.png", alt: alt1 },
    { src: "/assents/imagenes/MuseoDeCasa/Carrusel/MuseoDeCasaC4.png", alt: alt1 }
  ];
